package com.kob.generator.controller;
...
import com.kob.generator.service.IGenTableService;
...
public class GenController extends BaseController {
     ...
     * 导入表结构（保存）
     *
     * @param tableNameArray 表名串
     */

    @Log(title = "代码生成", businessType = BusinessType.IMPORT)
    @PostMapping("/importTable")
    public R<Void> importTableSave(String tableNameArray) {
        String[] tableNames = Convert.toStrArray(tableNameArray);
        // 查询表信息
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"kob.zip\"");
